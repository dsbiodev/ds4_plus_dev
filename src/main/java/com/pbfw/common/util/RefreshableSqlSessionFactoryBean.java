	...
	**/
	...
	public void refresh() throws Exception {
		if(log.isInfoEnabled()) {
			...
			System.out.println("refreshing SqlSessionFactory.");
		}
			...
			private boolean isModified() { 
				...
				if(mapperLocations != null) { 
					...
					try { 
						...
						try { xmlConfigBuilder.parse(); // Configuration 클래스의 protected member field 인 loadedResources 를 얻기 위해 reflection 을 사용함.
			...
			private boolean findModifiedResource(Resource resource) { 
				...
				if(retVal) {
					if(log.isInfoEnabled()) {
						...
						System.out.println("modified files : " + modifiedResources); 
					}
				}
