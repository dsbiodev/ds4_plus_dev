...
<script>
	$(function() {
		...
		var theadObj = {
			...
			theadRow:[['FUNERAL_NAME', '장례식장'], ['CNT', '진행']]
		};
		...
		var createTable = function(_searchObj) {
			$.pb.ajaxCallHandler('/adminSec/selectStatisticsFuneralList.do', _searchObj, function(tableData) {
		...
		$('.btn-excel').on('click', function(){
			fnExcelReport('statisticsFuneral', '장례식장별 통계');
		});
	});
</script>
<div class="contents-title-wrap">
	<div class="title">장례식장별 통계</div>
</div>
<div class="search-box-wrap">
	<div class="search-left-wrap">
		<div class="search-title">장례식장별 행사 건수</div>
	</div>
...
<div class="contents-body-wrap">
	<table class="pb-table list" id="statisticsFuneral">
		<colgroup></colgroup>
		<thead></thead>
		<tbody></tbody>
	</table>
