...
<script>
	$(function() {
		...
		searchObj.queryPage = (_param.pk ? (_param.pk-1)*(_param.display ? _param.display:20):0);
		searchObj.display = (_param.display ? _param.display:20);
...
// 	 						var _eventNo = (_tr.data('PARENT_EVENT_NO') ? _tr.data('PARENT_EVENT_NO'):_tr.data('EVENT_NO'));
	 						if(_tr.data('EVENT_NO')) {
	 							var stateObj = {
	 								link:'/29010301/'+_tr.data('EVENT_NO'), 
	 								page:'/manager/29010300'
	 							};
...
// 	 						var _eventNo = (_tr.data('PARENT_EVENT_NO') ? _tr.data('PARENT_EVENT_NO'):_tr.data('EVENT_NO'));
		...
		$('.search-right-wrap > .btn-register').on('click', function() {
			var stateObj = { link:'/29010301', page:'/manager/29010300' };
