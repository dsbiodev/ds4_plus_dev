...
<script>
	$(function() {
		...
		//var httpURL='${UrlType.HTTP}';
		//var httpsURL='${UrlType.HTTPS}';
		//alert(httpURL);
		//alert(httpsURL);
...
// 				var _fileName = _tempStr+'_0'+_divisionVal;
				$.pb.ajaxCallHandler('/admin/selectStatusPlateStyle.do', { flag:2, division:_divisionVal, thumbnail:$(this).data('no') }, function(detailData) {
					...
					if($('input[name=bottomText]').val()) _previews.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_'+_div+'_bottom_black_'+_thumb+'.png")');
					else _previews.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_'+_div+'_top_black_'+_thumb+'.png")');
...
// 										_popDiv.find('.title-box').append('<div class="time">'+new Date().format('MM월dd일 HH시mm분')+'</div>');
										...
										_popBinso.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_'+_imgDivide+'_'+(_thisLayer.find('input[name=bottomText]').val() ? 'bottom' : 'top')+'_black_'+(_style.THUMBNAIL ? _style.THUMBNAIL : $('.select.ac').parent('.style-item').data('no'))+'.png")');
										...
										if(_thisLayer.find('select[name=division]').val() == 1){ // 팝업 1분할
											...
											if(i % 2 != 0){ //분할이미지 표현
												...
												if(_chk){
													...
													_popDiv.find('.previews-box .binso-wrap').last().append(_divideImg);
													_divideImg.css('background-image', "url('+imgUrl+'/dsfiles/division/img_basic_two.png)");
												}
											}
											...
											if(i % 4 != 0){ //분할이미지 표현
												...
												if(_chk){
													...
													_popDiv.find('.previews-box .binso-wrap').last().append(_divideImg);
													_divideImg.css('background-image', "url('+imgUrl+'/dsfiles/division/img_basic_four.png)");
												}
											}
											...
											if(i % 6 != 0){ //분할이미지 표현
												...
												if(_chk){
													...
													_popDiv.find('.previews-box .binso-wrap').last().append(_divideImg);
													_divideImg.css('background-image', "url('+imgUrl+'/dsfiles/division/img_basic_six.png)");
												}
											}
										}else{ //팝업 8분할
											//빈소 정보 입력 + 빈소생성
											...
											if(i % 8 != 0){ //분할이미지 표현
												...
												if(_chk){
													...
													_popDiv.find('.previews-box .binso-wrap').last().append(_divideImg);
													_divideImg.css('background-image', "url('+imgUrl+'/dsfiles/division/img_basic_eight.png)");
												}
											}
										} // 8팝업 8분할 끝
...
// 											_div.find('.previews .title-box').append('<div class="time" style="font-size:18px;">'+new Date().format('MM월dd일 HH시mm분')+'</div>');
											...
											_binso.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_'+_imgDivide+'_bottom_black_'+_style.THUMBNAIL+'.png")');
											...
											if(_style.DIVISION == 1){ // 1분할
												...
												if(_div.find('.previews-box .binso-wrap').last().find('.binso-box').length < _style.DIVISION){
													...
													if(_chk){
														...
														_div.find('.previews .previews-box .binso-wrap').last().append(_divideImg);
														_divideImg.css('background-image', "url('+imgUrl+'/dsfiles/division/img_basic_"+_imgDivide+".png)");
													}
												}
...
// 											_div.find('.previews .title-box').append('<div class="time" style="font-size:18px;">'+new Date().format('MM월dd일 HH시mm분')+'</div>');
											...
											_binso.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_'+_imgDivide+'_top_black_'+_style.THUMBNAIL+'.png")');
											var _binsoBox = $('<div class="binso-box">');
// 											_binsoBox.append('<div class="status" style="color:'+_style.STATUS+'"></div>');
											_binsoBox.append('<div class="statusRoot"><div class="status style="color:'+_style.STATUS+'"></div></div>');
											_binsoBox.append('<div class="name" style="color:'+_style.NAME+'"></div>');
												...
												$.each(_binsoArr, function(idx){
													$.each(_event, function(){
														if(_binsoArr[idx] == this.RASPBERRY_CONNECTION_NO){
															...
															_binso.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_one_bottom_black_'+_style.THUMBNAIL+'.png")');
												...
												$.each(_binsoArr, function(idx){
													$.each(_event, function(){
														if(_binsoArr[idx] == this.RASPBERRY_CONNECTION_NO){
															...
															_binso.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_one_top_black_'+_style.THUMBNAIL+'.png")');
															_binso.append('<div class="binso-box">');
// 															_binso.find('.binso-box').append('<div class="status" style="color:'+_style.STATUS+'">'+this.APPELLATION+'</div>');
															_binso.find('.binso-box').append('<div class="statusRoot"><div class="status style="color:'+_style.STATUS+'">'+this.APPELLATION+'</div></div>');
...
// 												_div.find('.previews .title-box').append('<div class="time" style="font-size:18px;">'+new Date().format('MM월dd일 HH시mm분')+'</div>');
												...
												_binso.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_two_bottom_black_'+_style.THUMBNAIL+'.png")');
												var _binsoBox = $('<div class="binso-box">');
												_binsoBox.append('<div class="statusRoot"><div class="status style="color:'+_style.STATUS+'"></div></div>');
												_binsoBox.append('<div class="name" style="color:'+_style.NAME+'"></div>');
												_binsoBox.append('<div class="arrow"></div>');
...
// 												_div.find('.previews .title-box').append('<div class="time" style="font-size:20px;">'+new Date().format('MM월dd일 HH시mm분')+'</div>');
												...
												_binso.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_two_top_black_'+_style.THUMBNAIL+'.png")');
												var _binsoBox = $('<div class="binso-box">');
												_binsoBox.append('<div class="statusRoot"><div class="status style="color:'+_style.STATUS+'"></div></div>');
												_binsoBox.append('<div class="name" style="color:'+_style.NAME+'"></div>');
												_binsoBox.append('<div class="arrow"></div>');
...
// 												_div.find('.previews .title-box').append('<div class="time" style="font-size:18px;">'+new Date().format('MM월dd일 HH시mm분')+'</div>');
												...
												_binso.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_four_bottom_black_'+_style.THUMBNAIL+'.png")');
												var _binsoBox = $('<div class="binso-box">');
// 												_binsoBox.append('<div class="status" style="color:'+_style.STATUS+'"></div>');
												_binsoBox.append('<div class="statusRoot"><div class="status style="color:'+_style.STATUS+'"></div></div>');
												_binsoBox.append('<div class="name" style="color:'+_style.NAME+'"></div>');
...
// 												_div.find('.previews .title-box').append('<div class="time" style="font-size:20px;">'+new Date().format('MM월dd일 HH시mm분')+'</div>');
												...
												_binso.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_four_top_black_'+_style.THUMBNAIL+'.png")');
												var _binsoBox = $('<div class="binso-box">');
// 												_binsoBox.append('<div class="status" style="color:'+_style.STATUS+'"></div>');
												_binsoBox.append('<div class="statusRoot"><div class="status style="color:'+_style.STATUS+'"></div></div>');
												_binsoBox.append('<div class="name" style="color:'+_style.NAME+'"></div>');
...
// 												_div.find('.previews .title-box').append('<div class="time" style="font-size:18px;">'+new Date().format('MM월dd일 HH시mm분')+'</div>');
												...
												_binso.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_six_bottom_black_'+_style.THUMBNAIL+'.png")');
												var _binsoBox = $('<div class="binso-box">');
// 												_binsoBox.append('<div class="status" style="color:'+_style.STATUS+'"></div>');
												_binsoBox.append('<div class="statusRoot"><div class="status style="color:'+_style.STATUS+'"></div></div>');
												_binsoBox.append('<div class="name" style="color:'+_style.NAME+'"></div>');
...
// 												_div.find('.previews .title-box').append('<div class="time" style="font-size:20px;">'+new Date().format('MM월dd일 HH시mm분')+'</div>');
												...
												_binso.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_six_top_black_'+_style.THUMBNAIL+'.png")');
												var _binsoBox = $('<div class="binso-box">');
// 												_binsoBox.append('<div class="status" style="color:'+_style.STATUS+'"></div>');
												_binsoBox.append('<div class="statusRoot"><div class="status style="color:'+_style.STATUS+'"></div></div>');
												_binsoBox.append('<div class="name" style="color:'+_style.NAME+'"></div>');
...
// 												_div.find('.previews .title-box').append('<div class="time" style="font-size:18px;">'+new Date().format('MM월dd일 HH시mm분')+'</div>');
												...
												_binso.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_eight_bottom_black_'+_style.THUMBNAIL+'.png")');
												var _binsoBox = $('<div class="binso-box">');
// 												_binsoBox.append('<div class="status" style="color:'+_style.STATUS+'"></div>');
												_binsoBox.append('<div class="statusRoot"><div class="status style="color:'+_style.STATUS+'"></div></div>');
												_binsoBox.append('<div class="name" style="color:'+_style.NAME+'"></div>');
...
// 												_div.find('.previews .title-box').append('<div class="time" style="font-size:20px;">'+new Date().format('MM월dd일 HH시mm분')+'</div>');
												...
												_binso.css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_eight_top_black_'+_style.THUMBNAIL+'.png")');
												var _binsoBox = $('<div class="binso-box">');
// 												_binsoBox.append('<div class="status" style="color:'+_style.STATUS+'"></div>');
												_binsoBox.append('<div class="statusRoot"><div class="status style="color:'+_style.STATUS+'"></div></div>');
												_binsoBox.append('<div class="name" style="color:'+_style.NAME+'"></div>');
