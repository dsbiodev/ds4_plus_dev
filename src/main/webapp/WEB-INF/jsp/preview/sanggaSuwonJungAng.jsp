...
<style>
	...
	.appllation-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }
 	.appllation { font-size: 35px; width: 100%; text-align: center; display: flex; justify-content: center; align-items: center; }
	...
	function sanggaInit(_funeralNo){
	     $.pb.ajaxCallHandler('/admin/selectSanggaList.do', { order:'EXPOSURE ASC, APPELLATION ASC', funeralNo:_funeralNo, statusPlate:true }, function(data) {
	        ...
	        $.each(_list, function(i, oneData){
				...
				if(oneData.APPELLATION !=null && oneData.APPELLATION !=""){
	              ...
	              //상주명 추가
	           	...
	           	var r1="TEL : 031-231-9136";
	           	var r2="TEL : 031-231-9133";
	           	var r3="TEL : 031-231-9134";
	           	var r4="TEL : 031-231-9135";
	           	...
	           	tbody.append('<tr>'+
	           		'<td rowspan="3" style="width:8%;"><div class="font-wrap"><div class="appllation">'+oneData.APPELLATION+'</div></div></td>'+			//빈소명  
		           	...
		           	'<tr>'+enterSDt+'</tr>'+
		           	'<tr>'+carryDt+ '<td><div class="bigo-tel-wrap" style="font-style:italic;"> '+roomPhone+'</div></td></tr>'
		           	);
        	});
	        table.append(thead);
	        table.append(tbody);
	        ...
	        if(dataLen <= 6){//64px
	           ...
	           var rHeight = '80px'; //td 기본 높이
	           $('.sangga-table-body .td').height(rHeight+'px');	           
	           $('.sangga-table-body .goin-wrap').height(100 + 'px');		//고인(goin-wrap)
	           $('.sangga-table-body .sangjuNm-wrap').height(110 + 'px');	//상주관계:상주명(sangjuNm-wrap)
	           $('.sangga-table-body .bigo-wrap').height(80 + 'px');		//비고(bigo-wrap)
	           $('.sangga-table-body .bigo-tel-wrap').height(38 + 'px');	//전화번호 높이 조정
...
<body>
   <div class="sangga-container">
      <div class="sangga-div-top">
         ...
         <div class="sangga-div-top-right-main"><div class="sangga-div-top-right"></div></div>
