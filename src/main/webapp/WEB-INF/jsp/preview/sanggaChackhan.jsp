...
<style>
	...
	.sangjuNm-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }
 	...
 	.goinH { font-size: 19px; width: 100%; text-align: left; display: flex; justify-content: center; align-items: center; }
	        ...
	        $.each(_list, function(i, oneData){
				...
				if(oneData.APPELLATION !=null && oneData.APPELLATION !=""){
	           	...
	           	tbody.append('<tr>'+
	           		...
	           		'<td rowspan="3" style="width:10%;"><div class="font-wrap"><div class="goinH">'+nameAreaStr+'</div></div></td>'+							//고인명
		           	...
		           	'<td rowspan="3" style="width:26%;"><div class="bigo-wrap"><div class="bigo">'+bigo+'</div></div></td>'+		           	
