...
.religionLogo { display: flex; align-items: center; justify-content:center; padding-left: 2px;}
...
<script>
	function makeUI(data, index){
		...
		if(style[0].BOTTOM_TEXT != ''){
			...
			$('.swiper-slide.page.p'+index).css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_eight_bottom_black_'+style[0].STATUS_PLATE_STYLE_NO+'.png")');
			...
			basicLayer.append('<div class="eight-preview-wrap epw'+index+'"></div>');
			$('.swiper-slide.page.p'+index).html(basicLayer);
			$('.swiper-slide.page.p'+index).css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_eight_top_black_'+style[0].STATUS_PLATE_STYLE_NO+'.png")');
		...
		$.each(evt, function(i, evtItem){
			...
			if(evtItem.DM_RELIGION == 1){		//기독교
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/1_christian.png" alt="national christian" width="50" height="50"></div>';
			}else if(evtItem.DM_RELIGION == 2){ //천주교
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/2_catholic.png" alt="national catholic" width="55" height="45"></div>';
			}else if(evtItem.DM_RELIGION == 3){ //불교
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/3_buddhism.png" alt="national buddhism" width="40" height="40"></div>';
			}else if(evtItem.DM_RELIGION == 4){ //원불교
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/4_wonbuddhism.png" alt="national wonbuddhism" width="45" height="45"></div>';
			}else if(evtItem.DM_RELIGION == 5){ //국가유공자
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/5_merit.png" alt="national merit" width="52" height="48" ></div>';
			}else {
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/6_user.png" alt="national nothing" width="50" height="48" ></div>';
			}
		...
		if( evt.length/8 < 1 ){
			$('.binso.i'+index+'.b7').css('background-image', "url('+imgUrl+'/dsfiles/division/img_basic_eight.png");
			if(style[0].BOTTOM_TEXT != ''){
