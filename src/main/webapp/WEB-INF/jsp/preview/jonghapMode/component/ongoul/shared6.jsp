...
.religionLogo { display: flex; align-items: center; justify-content:center; padding-left: 7px;}
...
<script>
	function makeUI(data, index){
		...
		if(style[0].BOTTOM_TEXT != ''){
			...
			$('.swiper-slide.page.p'+index).css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_six_bottom_black_'+style[0].STATUS_PLATE_STYLE_NO+'.png")');
		}else{
			// 하단 문구가 없는 경우 //
			var basicLayer = $('<div class="six-basic-layer" style="width:100%; height:100%; display:flex; flex-direction: column; ">');
			...
			basicLayer.append('</div>');
			$('.swiper-slide.page.p'+index).html(basicLayer);
			$('.swiper-slide.page.p'+index).css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_six_top_black_'+style[0].STATUS_PLATE_STYLE_NO+'.png")');
		}
		...
		$.each(evt, function(i, evtItem){
			...
			if(evtItem.DM_RELIGION == 1){		//기독교
				...
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/2_catholic.png" alt="national catholic" width="60" height="50"></div>';
				...
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/4_wonbuddhism.png" alt="national wonbuddhism" width="50" height="50"></div>';
			}else if(evtItem.DM_RELIGION == 5){ //국가유공자
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/5_merit.png" alt="national merit" width="60" height="55" ></div>';
			}else if(evtItem.DM_RELIGION == 6){
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/6_user.png" alt="national nothing" width="50" height="55" ></div>';
			}
		...
		if( evt.length/6 < 1 ){
			$('.binso.i'+index+'.b5').css('background-image', "url('+imgUrl+'/dsfiles/division/img_basic_six.png");
			if(style[0].BOTTOM_TEXT != ''){
