...
.religionLogo { display: flex; align-items: center; justify-content:flex-start; margin-left: -8px; }
</style>
<head>
<script>
	function makeUI(data, index) {
		...
		*/
		...
		if(style[0].BOTTOM_TEXT != ''){
			...
			$('.swiper-slide.page.p'+index).css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_two_bottom_black_'+style[0].STATUS_PLATE_STYLE_NO+'.png")');
		}else{
			// 하단 문구가 없는 경우 //
			var basicLayer = $('<div class="two-basic-layer" style="width:100%; height:100%; display:flex; flex-direction: column; ">');
			...
			basicLayer.append('</div>');
			$('.swiper-slide.page.p'+index).html(basicLayer);
			$('.swiper-slide.page.p'+index).css('background-image', 'url("'+imgUrl+'/dsfiles/division/img_division_two_top_black_'+style[0].STATUS_PLATE_STYLE_NO+'.png")');
		...
		$.each(evt, function(i, evtItem){
			...
			if(evtItem.DM_RELIGION == 1){		//기독교
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/1_christian.png" alt="national christian" width="70" height="80"></div>';
			}else if(evtItem.DM_RELIGION == 2){ //천주교
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/2_catholic.png" alt="national catholic" width="75" height="70"></div>';
			}else if(evtItem.DM_RELIGION == 3){ //불교
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/3_buddhism.png" alt="national buddhism" width="65" height="65"></div>';
			}else if(evtItem.DM_RELIGION == 4){ //원불교
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/4_wonbuddhism.png" alt="national wonbuddhism" width="70" height="70"></div>';
			}else if(evtItem.DM_RELIGION == 5){ //국가유공자
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/5_merit.png" alt="national merit" width="90" height="78" ></div>';
			}else if(evtItem.DM_RELIGION == 6){
				imgPath='<div class="religionLogo"><img src="/resources/img/ongoul/6_user.png" alt="national nothing" width="90" height="78" ></div>';
			}
			...
			if(i<2){
				...
				//$('.binso.i'+index+'.b'+i).append('<div class="binso-top"><div class="bin-top-left"><div class="bin-hosil">'+evtItem.APPELLATION+'</div></div><div><img src="/resources/img/national_merit.png" alt="national merit" width="50" height="70"></div><div class="bin-top-center"><div class="bin-goin">'+nameAreaStr+'</div></div><div class="bin-top-right arrow"></div></div>'); //<img src="/resources/img/national_merit.png" alt="national merit" width="50" height="70"> -- original
				
				//수정 요하는 부분
				
				//if(evtItem.DM_RELIGION == 5){
					//alert("5");
					//$('.binso.i'+index+'.b'+i).append('<div class="binso-top"><div class="bin-top-left"><div class="bin-hosil">'+evtItem.APPELLATION+'</div></div>' + imgPath + '<div class="bin-top-center"><div class="bin-goin">'+nameAreaStr+'</div></div><div class="bin-top-right arrow"></div></div>'); //<img src="/resources/img/national_merit.png" alt="national merit" width="50" height="70">
				//}else{
					//alert("!5");
					$('.binso.i'+index+'.b'+i).append('<div class="binso-top"><div class="bin-top-left"><div class="bin-hosil">'+evtItem.APPELLATION+'</div></div>' + imgPath + '<div class="bin-top-center"><div class="bin-goin">'+nameAreaStr+'</div></div><div class="bin-top-right arrow"></div></div>'); //<img src="/resources/img/national_merit.png" alt="national merit" width="50" height="70">
				//}
				//$('.binso.i'+index+'.b'+i).append('<div class="binso-top"><div class="bin-top-left"><div class="bin-hosil">'+evtItem.APPELLATION+'</div></div>' + '<div class="bin-top-center"><div class="bin-goin">'+nameAreaStr+'</div></div><div class="bin-top-right arrow"></div></div>'); //<img src="/resources/img/national_merit.png" alt="national merit" width="50" height="70">
		...
		if( evt.length/2 < 1 ){
			$('.binso.i'+index+'.b1').css('background-image', "url('+imgUrl+'/dsfiles/division/img_basic_two.png");
			if(style[0].BOTTOM_TEXT != ''){
