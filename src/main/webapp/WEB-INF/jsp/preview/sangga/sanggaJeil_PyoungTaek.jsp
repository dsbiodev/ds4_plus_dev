...
<style>
	...
	.goinH { font-size: 25px; width: 100%; text-align: left; display: flex; justify-content: center; align-items: center; }
...
<script>
	function sanggaInit(_funeralNo){
	     $.pb.ajaxCallHandler('/admin/selectSanggaList.do', { order:'EXPOSURE ASC, APPELLATION ASC', funeralNo:_funeralNo, statusPlate:true }, function(data) {
	        ...
	        //thead.append('<tr><td>빈소</td><td>고인</td><td>상주</td><td colspan="2" style="letter-spacing:1.2px;">상례정보</td><td>장지</td><td style="letter-spacing:1.2px;">상조회사</td><td>비고</td></tr>');
	        thead.append('<tr><td>빈소</td><td>고인</td><td>상주</td><td colspan="2" style="letter-spacing:1.2px;">상례정보</td><td>장지</td>');
	        ...
	        $.each(_list, function(i, oneData){
				...
				//고인명 처리
	           	...
	           	tbody.append('<tr>'+
	           		'<td rowspan="3" style="width:8%;"><div class="font-wrap"><div class="appllationH">'+oneData.APPELLATION+'</div></div></td>'+
	           		'<td rowspan="3" style="width:10%;"><div class="font-wrap"><div class="goinH">'+nameAreaStr+'</div></div></td>'+
	           		'<td rowspan="3" style="width:60%;"><div class="sangjuNm-wrap"><div class="sangjuNmH">'+sangjuNm+'</div></div></td>'+enterDt+
	           		
		           	'<td rowspan="3" style="width:11%;"><div class="jangji-wrap"><div class="jangjiH">'+jangji+'</div></div></td>'+
		           	
		           	/* '<td rowspan="3" style="width:10%;"><div class="sangjo-wrap"><div class="sangjoH">'+sangjo+'</div></div></td>'+ */
		           	/* '<td style="width:3%;">사인</td><td style="width:6%;"><div class="ellipsis" style="width: 100%; padding: 0px;">'+cause+'</div></td>'+ */
		           	/* '<td rowspan="3" style="width:15%;"><div class="bigo-wrap"><div class="bigo">'+bigo+'</div></div></td></tr>'+ */
	        ...
	        if(dataLen <= 5){//64px
	           ...
	           */
	           ...
	           $('.sangga-table-body .jangji-wrap').height((rHeight*2+18)+'px');	//HYH - font-size 관련 추가
	           //$('.sangga-table-body .sangjo-wrap').height((rHeight*2+10)+'px');	//HYH - font-size 관련 추가
