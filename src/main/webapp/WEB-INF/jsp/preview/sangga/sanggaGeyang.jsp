...
<style>
	...
	.font-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }
 	...
 	.sangjuNm-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: normal; }
 	...
 	.appllationH { font-size: 25px; width: 100%; text-align: center; display: flex; justify-content: center; align-items: center; }
 	
 	.goin-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }
 	.goinH { font-size: 20px; width: 100%; text-align: center; display: flex; justify-content: center; align-items: center; }
...
<script>
	function sanggaInit(_funeralNo){
	     $.pb.ajaxCallHandler('/admin/selectSanggaList.do', { order:'EXPOSURE ASC, APPELLATION ASC', funeralNo:_funeralNo, statusPlate:true }, function(data) {
	        ...
	        //thead.append('<tr><td>빈소</td><td>고인</td><td>상주정보</td><td colspan="2" style="letter-spacing:1.2px;">상례정보</td><td>장지</td><td style="letter-spacing:1.2px;">상조회사</td><td colspan="2">정보</td><td>비고</td></tr>');
	        thead.append('<tr><td>빈소</td><td>고인</td><td>상주정보</td><td colspan="2" style="letter-spacing:1.2px;">상례정보</td><td>장지</td><td style="letter-spacing:1.2px;">상조회사</td><td style="letter-spacing:0px;padding-right:9px;padding-left:0px;">진단서</td><td>비고</td></tr>');
	        ...
	        $.each(_list, function(i, oneData){
				...
				/*
				if(oneData.APPELLATION=="사무실"){
					return ;
				}
				*/
				
				switch(oneData.APPELLATION){
				case "특실101호" :
					oneData.APPELLATION="101호<br>"+"(130평)";
					break;
				case "특실201호" :
					oneData.APPELLATION="201호<br>"+"(140평)";
					break;
				case "202호" :
					oneData.APPELLATION="202호<br>"+"(68평)";
					break;
				case "203호" :
					oneData.APPELLATION="203호<br>"+"(88평)";
					break;
				case "204호" :
					oneData.APPELLATION="204호<br>"+"(68평)";
					break;
				case "301호" :
					oneData.APPELLATION="301호<br>"+"(78평)";
					break;
				case "302호" :
					oneData.APPELLATION="302호<br>"+"(58평)";
					break;
				case "303호" :
					oneData.APPELLATION="303호<br>"+"(68평)";
					break;
				case "304호" :
					oneData.APPELLATION="304호<br>"+"(45평)";
					break;
				case "사무실" :
					return;
					break;
				  ...
				  //============= .상주 정보===================//
	           	...
	           	tbody.append('<tr>'+
	           		'<td rowspan="3" style="width:8%;"><div class="font-wrap"><div class="appllationH">'+oneData.APPELLATION+'</div></div></td>'+	//빈소
	           		'<td rowspan="3" style="width:10%;"><div class="goin-wrap"><div class="goinH">'+nameAreaStr+'</div></div></td>'+				//고인
	           		'<td rowspan="3" style="width:32%;"><div class="sangjuNm-wrap"><div class="sangjuNm">'+sangjuNm+'</div></div></td>'+enterDt+		//상주정보 + 입실
	           		
	           		/* 
		           	'<td rowspan="3" style="width:8%;"><div class="jangji-wrap"><div class="jangjiH">'+jangji+'</div></div></td>'+					//장지
		           	
		           	'<td rowspan="3" style="width:8%;"><div class="sangjo-wrap"><div class="sangjoH">'+sangjo+'</div></div></td>'+					//상조
		           	 */
		           	'<td rowspan="3" style="width:8%;"><div class="jangji-wrap"><div class="jangji">'+jangji+'</div></div></td>'+
		           	'<td rowspan="3" style="width:8%;"><div class="sangjo-wrap"><div class="sangjo">'+sangjo+'</div></div></td>'+																			//상조
		           	
		           	//'<td style="width:3%;">사인</td><td style="width:6%;"><div class="ellipsis" style="width: 100%; padding: 0px;">'+cause+'</div></td>'+
		           	
		           	'<td rowspan="3" style="width:7%">'+dy+'</td>'+
		           	
		           	
		           	'<td rowspan="3" style="width:14%;"><div class="bigo-wrap"><div class="bigo">'+bigo+'</div></div></td></tr>'+
	        ...
	        if(dataLen <= 5){//64px
	           ...
	           $('.sangga-table-body .bigo-wrap').height((rHeight*3+25)+'px');
	           $('.sangga-table-body .goin-wrap').height((rHeight*3+20)+'px');
	           $('.sangga-table-body .font-wrap').height((rHeight*3+20)+'px');	//HYH - font-size 관련 추가
	           
	           $('.sangga-table-body .sangjuNm-wrap').height((rHeight*3+25)+'px');	//상주 정보
 				
 				
 			   $('.sangga-table-body .jangji-wrap').height(45+'px');		//장지(jangji-wrap)
 	           $('.sangga-table-body .sangjo-wrap').height(45+'px');		//상조(sangjo-wrap)
	        }
	...
	/*      .jangji-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }
 			...
 			.sangjo-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }
 			.sangjoH { font-size: 17px; width: 100%; text-align: left; display: flex; justify-content: center; align-items: center; }
	         */
