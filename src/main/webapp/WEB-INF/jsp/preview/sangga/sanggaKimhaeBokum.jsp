	...
	function sanggaInit(_funeralNo){
	     $.pb.ajaxCallHandler('/admin/selectSanggaList.do', { order:'EXPOSURE ASC, APPELLATION ASC', funeralNo:_funeralNo, statusPlate:true }, function(data) {
	        ...
	        $.each(_list, function(i, oneData){
				...
				*/
				...
				if(oneData.APPELLATION !=null && oneData.APPELLATION !=""){
	           	...
	           	tbody.append('<tr>'+
	           		'<td rowspan="3" style="width:7%;"><div class="appllation-wrap"><div class="appllationH">'+appellationInfo+'</div></div></td>'+			//빈소명  
	           		//'<td rowspan="3" style="width:8%;"><div class="font-wrap"><div class="appllationH">'+f_parlor+'<br>'+f_parlor_floor+'</div></div></td>'+			//빈소명
	           		'<td rowspan="3" style="width:14%;"><div class="goin-wrap"><div class="goinH">'+nameAreaStr+'</div></div></td>'+							//고인명
	        ...
	        if(dataLen <= 5){//64px
	           ...
	           $('.sangga-table-body .goin-wrap').height((rHeight*3-10)+'px'); 
	           $('.sangga-table-body .sangjuNm-wrap').height((rHeight*4+6)+'px');		        
		       $('.sangga-table-body .bigo-wrap').height((rHeight*3+26)+'px'); 
		       $('.sangga-table-body .font-wrap').height((rHeight*2+20)+'px');	
		       $('.sangga-table-body .jangji-wrap').height((rHeight*4-80)+'px');
