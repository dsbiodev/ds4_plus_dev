...
<style>
	...
	.sangjuNm-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }
 	.sangjuNm { font-size: 20px; width: 100%; text-align: left; display: flex; justify-content: flex-start; align-items: center; }
 	
 	 
 	
 	.appllation { font-size: 25px; width: 100%; text-align: center; display: flex; justify-content: center; align-items: center; }
 	.goin { font-size: 19px; width: 100%; text-align: left; display: flex; justify-content: center; align-items: center; }
 	.sangjuNm { font-size: 17px; width: 100%; text-align: left; display: flex; justify-content: center; align-items: center; }
 	.jangji { font-size: 21px; width: 100%; text-align: left; display: flex; justify-content: center; align-items: center; } 	
 	*/ 	
 	
 	.font-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }
		
	.appllation-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }
	.appllationH { font-size: 27px; width: 100%; text-align: center; display: flex; justify-content: center; align-items: center; }
	
	.goin-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }	
	.goinH { font-size: 24px; width: 100%; text-align: center; display: flex; justify-content: center; align-items: center; }
		
		
	/* .sangjuNm-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; } */
	.sangjuNm-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }	
	.sangjuNmH { font-size: 26px; width: 100%; text-align: left; display: flex; justify-content: flex-start; align-items: center; }
	
	.jangji-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }
 	.jangjiH { font-size: 20px; width: 100%; text-align: left; display: flex; justify-content: flex-start; align-items: center; }
 	
 	/* .sangjo-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }
 	.sangjoH { font-size: 20px; width: 100%; text-align: left; display: flex; justify-content: center; align-items: center; }
 	 */
...
<script>
	function sanggaInit(_funeralNo){
	     $.pb.ajaxCallHandler('/admin/selectSanggaList.do', { order:'EXPOSURE ASC, APPELLATION ASC', funeralNo:_funeralNo, statusPlate:true }, function(data) {
	        ...
	        thead.append('<tr><td>빈소</td><td>고인</td><td>상주정보</td><td colspan="2" style="letter-spacing:1.2px;">상례정보</td><td>장지</td><td colspan="2">정보</td><td style="letter-spacing:8px;">제사 및 인계사항</td></tr>');
	        ...
	        $.each(_list, function(i, oneData){
				...
				if(oneData.APPELLATION !=null && oneData.APPELLATION !=""){
					...
					f_parlor=tmp1[0];
					f_parlor_floor=tmp2; 
					f_parlor=oneData.APPELLATION;*/
					if(oneData.APPELLATION.indexOf('(') != -1){
						var tmp1=oneData.APPELLATION.split('(');
						var tmp2="("+tmp1[1]
						f_parlor=tmp1[0];
						f_parlor_floor=tmp2;
						appellationInfo=f_parlor+"<br>"+f_parlor_floor;
					}else{
						appellationInfo=oneData.APPELLATION;
					}
	           	...
	           	tbody.append('<tr>'+
	           		...
	           		//'<td rowspan="3" style="width:8%;"><div class="font-wrap"><div class="appllationH">'+f_parlor+'<br>'+f_parlor_floor+'</div></div></td>'+			//빈소명
	           		//'<td rowspan="3" style="width:8%;"><div class="font-wrap"><div class="appllationH">'+f_parlor+'</div></div></td>'+			//빈소명
	           		'<td rowspan="3" style="width:8%;"><div class="appllation-wrap"><div class="appllationH">'+appellationInfo+'</div></div></td>'+			//빈소명
	           		'<td rowspan="3" style="width:12%;"><div class="goin-wrap"><div class="goinH">'+nameAreaStr+'</div></div></td>'+							//고인명
	           		//'<td rowspan="3" style="width:30%;"><div class="sangjuNm-wrap"><div class="font-wrap"><div class="sangjuNmH">'+sangjuNm+'</div></div></div></td>'+	//상주관계
	           		//enterDt+	//입실
		           	
	           		//'<td rowspan="3" style="width:37%;"><div class="font-wrap"><div class="sangjuNmH">'+sangjuNm+'</div></div></td>'+	//상주관계
	           		'<td rowspan="3" style="width:37%;"><div class="sangjuNm-wrap"><div class="sangjuNmH">'+sangjuNm+'</div></div></td>'+	//상주관계
	           		enterDt+
	           		
	           		'<td rowspan="3" style="width:8%; "><div class="jangji-wrap"><div class="jangjiH">'+jangji+'</div></div></td>'+
		           	/* '<td rowspan="3" style="width:10%;">'+sangjo+'</td>'+ */
		           	
		           	'<td style="width:3%;"><font color="lightgray">사인</font></td><td style="width:3%;"><div class="ellipsis" style="width: 100%; padding: 0px;">'+""+'</div></td>'+
		           	
		           	'<td rowspan="3" style="width:18%;"><div class="bigo-wrap"><div class="bigo">'+bigo+'</div></div></td>'+		           	
		           	//'<td rowspan="3" style="width:50%;"><div class="sangjuNm-wrap"><div class="sangjuNm">'+sangjuNm+'</div></div></td></tr>'+
	        ...
	        if(dataLen <= 5){//64px
	            ...
	            */
	            ...
	            $('.sangga-table-body .bigo-wrap').height((rHeight*3+20)+'px');	//비고
	            ...
	            $('.sangga-table-body').find('td').css('font-size','16px');
	            $('.sangga-table-body .sangjuNm-wrap').height((rHeight*4+6)+'px');//90 원래 
		        
	            $('.sangga-table-body .goin-wrap').height((rHeight*3+10)+'px'); //82.25
		        
		        $('.sangga-table-body .bigo-wrap').height((rHeight*3+26)+'px'); //88.25
		        $('.sangga-table-body .font-wrap').height((rHeight*2+20)+'px');	//61.5
		        $('.sangga-table-body .jangji-wrap').height((rHeight*4-45)+'px'); //48
		           //$('.sangga-table-body .sangjo-wrap').height((rHeight*2+10)+'px');	//H
	     ...
	     // 비고 쪽 글자 크기 줄여줌
	        ...
	        $('.sangga-table-body .appllationH').css('height', '100%').css('overflow', 'hidden');
	     ...
	     // 고인명 글자 크기 줄여줌
	        ...
	        $('.sangga-table-body .jangji').each(function() {//장지
				autoFontSize( $(this), $(this).parent('.jangji-wrap'));
	        });
	        $('.sangga-table-body .sangjo').each(function() {//상조
				autoFontSize( $(this), $(this).parent('.font-wrap'));
	        });
	     ...
	     // 글자크기 이후 줄여줌
	        ...
	        $('.sangga-table-body .applation').css('height', '100%').css('overflow', 'hidden');
