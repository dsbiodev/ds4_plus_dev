...
<style>
	...
	.bigo-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }
 	...
 	.sangjuNm { font-size: 22px; width: 100%; text-align: left; display: flex; justify-content: flex-start; align-items: center; }
	...
	function sanggaInit(_funeralNo){
	     $.pb.ajaxCallHandler('/admin/selectSanggaList.do', { order:'EXPOSURE ASC, APPELLATION ASC', funeralNo:_funeralNo, statusPlate:true }, function(data) {
	        ...
	        $.each(_list, function(i, oneData){
				...
				//고인명 처리
	              ...
	              //상주명 추가
	           	...
	           	tbody.append('<tr>'+
	           		'<td rowspan="3" style="width:8%;"><div class="appllation-wrap"><div class="appllation">'+f_parlor+''+f_parlor_floor+'</div></div></td>'+			//빈소명
	           		'<td rowspan="3" style="width:12%;"><div class="goin-wrap"><div class="goin">'+nameAreaStr+'</div></div></td>'+			//고인명
	           		'<td rowspan="3" style="width:31%;"><div class="sangjuNm-wrap"><div class="sangjuNm">'+sangjuNm+'</div></div></td>'+	//상주관계
	           		enterDt+
		           	...
		           	'<td rowspan="3" style="width:16%;"><div class="bigo-wrap"><div class="bigo">'+bigo+'</div></div></td>'+		           	
	        ...
	        if(dataLen <= 5){//64px
	           ...
	           $('.sangga-table-body .sangjuNm-wrap').height(170 + 'px');	//상주관계:상주명(sangjuNm-wrap)
	           ...
	           $('.sangga-table-body .place-wrap').height(32 + 'px');		//사망장소(place-wrap)
	        	...
	        	var rHeight = ((950 / (dataLen * 5)) - 3 ) ;
		           $('.sangga-table-body .td').height(rHeight+'px');
		           $('.sangga-table-body .bigo-wrap').height(120 + 'px');		//비고(bigo-wrap)
		           $('.sangga-table-body .sangjuNm-wrap').height(120 + 'px');	//상주관계:상주명(sangjuNm-wrap)
		           
		           $('.sangga-table-body .goin-wrap').height(110 + 'px');		//고인(goin-wrap)
		           $('.sangga-table-body .jangji-wrap').height(50 + 'px');		//장지(jangji-wrap)
		           $('.sangga-table-body .sangjo-wrap').height(42 + 'px');		//상조(sangjo-wrap)
		           //$('.sangga-table-body .place-wrap').height(32 + 'px');		//사망장소(place-wrap)
