	...
	function sanggaInit(_funeralNo){
	     $.pb.ajaxCallHandler('/admin/selectSanggaList.do', { order:'EXPOSURE ASC, APPELLATION ASC', funeralNo:_funeralNo, statusPlate:true }, function(data) {
	        ...
	        $.each(_list, function(i, oneData){
				...
				//고인명 처리
	              ...
	              //상주명 추가
	           	...
	           	tbody.append('<tr>'+
	           		'<td rowspan="3" style="width:10%;"><div class="appllation-wrap"><div class="appllation">'+f_parlor+''+f_parlor_floor+'</div></div></td>'+			//빈소명
	           		'<td rowspan="3" style="width:14%;"><div class="goin-wrap"><div class="goin">'+nameAreaStr+'</div></div></td>'+			//고인명
	           		'<td rowspan="3" style="width:35%;"><div class="sangjuNm-wrap"><div class="sangjuNm">'+sangjuNm+'</div></div></td>'+	//상주관계
	           		enterDt+
		           	...
		           	'<td style="width:3%;">안치</td><td style="width:3%;"><div>'+cause+'</div></td>'+
		           	
		           	'<td rowspan="3" style="width:13%;"><div class="bigo-wrap"><div class="bigo">'+bigo+'</div></div></td>'+		           	
	        ...
	        if(dataLen <= 5){//64px
	           ...
	           $('.sangga-table-body .sangjuNm-wrap').height(180 + 'px');	//상주관계:상주명(sangjuNm-wrap)
