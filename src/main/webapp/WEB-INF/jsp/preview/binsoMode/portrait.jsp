...
.swiper-container .swiper-wrapper { height: 100%; flex-direction: column; }
.swiper-container .swiper-wrapper .swiper-slide { display: flex; justify-content: flex-start; align-items: center; font-size: 50px; }
.swiper-container .swiper-wrapper .swiper-slide img { height: 100%; padding : 8px; box-sizing: border-box; }
.swiper-container .swiper-wrapper .swiper-slide .comment {color: #FFF; height: 100%; padding-top: 8px; box-sizing: border-box; width:calc(100% - 80px); }
