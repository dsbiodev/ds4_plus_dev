...
<style>
	...
	.goin { font-size: 28px; width: 100%; text-align: center; display: flex; justify-content: center; align-items: center; }
	...
	function sanggaInit(_funeralNo){
	     $.pb.ajaxCallHandler('/admin/selectSanggaList.do', { order:'EXPOSURE ASC, APPELLATION ASC', funeralNo:_funeralNo, statusPlate:true }, function(data) {
	        ...
	        $.each(_list, function(i, oneData){
				...
				if(oneData.APPELLATION !=null && oneData.APPELLATION !=""){
	           	...
	           	tbody.append('<tr>'+
	           		...
	           		'<td rowspan="3" style="width:8%;"><div class="appllation-wrap"><div class="appllation">'+f_parlor+'</div></div></td>'+			//빈소명
	           		'<td rowspan="3" style="width:15%;"><div class="goin-wrap"><div class="goin">'+nameAreaStr+'</div></div></td>'+			//고인명
		           	...
		           	'<td rowspan="3" style="width:10%;"><div class="bigo-wrap"><div class="bigo">'+bigo+'</div></div></td>'+		           	
	        ...
	        if(dataLen < 5){//64px
	           ...
	           var rHeight = '200px';
	           $('.sangga-table-body .td').height(rHeight+'px');
	           $('.sangga-table-body .bigo-wrap').height(200 + 'px');		//비고(bigo-wrap)
	           $('.sangga-table-body .sangjuNm-wrap').height(200 + 'px');	//상주관계:상주명(sangjuNm-wrap)
	           $('.sangga-table-body .goin-wrap').height(110 + 'px');		//고인(goin-wrap)
	           ...
	           $('.sangga-table-body .place-wrap').height(32 + 'px');		//사망장소(place-wrap)
	        	...
	        	if(dataLen >= 5 ){
	        	   ...
	        	   $('.sangga-table-body .td').height(rHeight+'px');
	 	           $('.sangga-table-body .bigo-wrap').height(160 + 'px');		//비고(bigo-wrap)
	 	           $('.sangga-table-body .sangjuNm-wrap').height(160 + 'px');	//상주관계:상주명(sangjuNm-wrap)
	 	           $('.sangga-table-body .goin-wrap').height(130 + 'px');		//고인(goin-wrap)
	 	           $('.sangga-table-body .jangji-wrap').height(rHeight + 'px');		//장지(jangji-wrap)
	 	           $('.sangga-table-body .sangjo-wrap').height(rHeight + 'px');		//상조(sangjo-wrap)
	 	           $('.sangga-table-body .place-wrap').height(rHeight + 'px');		//사망장소(place-wrap)
