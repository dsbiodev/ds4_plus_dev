...
<style>
	...
	.jangji-wrap { display: flex; justify-content: center; align-items: center; height: 100%; white-space: pre-wrap; }
 	...
 	.goinH { font-size: 50px; width: 100%; text-align: left; display: flex; justify-content: center; align-items: center; }
	     ...
	     $.pb.ajaxCallHandler('/admin/selectSanggaList.do', { order:'EXPOSURE ASC, APPELLATION ASC', funeralNo:_funeralNo, statusPlate:true }, function(data) {
	        ...
	        $.each(_list, function(i, oneData){
				...
				var carryDt = '<td>발인</td><td></td>';
	           	...
	           	tbody.append('<tr>'+
	           		'<td rowspan="3" style="width:10%;"><div class="font-wrap"><div class="appllationH">'+oneData.APPELLATION+'</div></div></td>'+
	           		'<td rowspan="3" style="width:12%;"><div class="font-wrap"><div class="goinH">'+nameAreaStr+'</div></div></td>'+
	           		'<td rowspan="3" style="width:6%;"><div class="font-wrap"><div class="sangjuNmH">'+sjName+'</div></div></td>'+enterDt+
	           		
		           	'<td rowspan="3" style="width:10%;"><div class="jangji-wrap"><div class="jangjiH">'+jangji+'</div></div></td>'+
		           	
		           	'<td rowspan="3" style="width:10%;"><div class="font-wrap"><div class="sangjoH">'+sangjo+'</div></div></td>'+
